<div class="container">
    <div class="card shadow headnew">
        <div class="card-body">
            <div class="row">
                <div class="col-md-9">
                    <h3><strong style="color:black">Detail </strong><strong style="color:#2146C7">Produk</strong></h3>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('products') }}">List Menu</a></li>
                            <li class="breadcrumb-item active" aria-current="page" style="color:black">Detail Menu</li>
                        </ol>
                    </nav>
                </div>
            </div>

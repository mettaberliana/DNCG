...
<div class="container">
    <div class="card shadow headnew">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h3><strong style="color:black">List </strong><strong style="color:#2146C7">Product</strong></h3>
                </div>
                <div class="col">
            ...
            <div class="col-md-3 mb-3">
                <div class="card" style="border-radius: 0.5rem;">
                    <div class=" card-body text-center headnew shadow" style="border-radius: 0.5rem; height: 20rem">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <h6><strong style="color:#2146C7">{{ $product->nama }}</strong> </h6>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                ...
                                <a href="{{route('product.delete', $product->id)}}" class="btn btn-danger" onclick="return confirm('Yakin akan menhapus Produk ? ')"><i class="fas fa-trash"></i>Hapus</a>
                            </div>
                        </div>
                    </div>
                </div>

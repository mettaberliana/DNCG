...
<div class="container">
    <div class="card shadow headnew">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h3><strong style="color:black">Detail </strong><strong style=" color:#2146C7">Product</strong></h3>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col">
...
<div class="container mt-4">
    <center>
        <hr>
        <h4><strong>Detail </strong><strong style="color:#2146C7">Product</strong></h4>
        <hr>
    </center>
    <div class="row mt-4">
        <div class="col-md-6">
            <div class="card shadow headnew">
                <div class="card-body">
                    <h2 style="color:#2146C7"><strong>{{$productDetail->nama}}</strong></h2>
                    <br>

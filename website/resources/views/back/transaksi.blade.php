...
<div class="container">
    <div class="card shadow headnew">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <h3><strong style="color:black">Riwayat </strong><strong style="color:#2146C7">Transaksi</strong></h3>
                </div>
                <div class="col">
...
<div class="container">
    <div class="row mt-4">
        <div class="col">
            <center>
                <hr>
                <h4><strong>Pesanan </strong><strong style="color:#2146C7">Baru</strong></h4>
                <hr>
            </center>
...
<div class="container">
    <div class="row">
        <div class="col">
            <<center>
                <hr>
                <h4><strong>Perlu </strong><strong style="color:#2146C7">Dikirim</strong></h4>
                <hr>
                </center>
                <div class="table-responsive">
                    <table class="table table-bordered  text-center" style=" border-radius: 0.5rem">
...
<div class="container">
    <div class="row">
        <div class="col">
            <center>
                <hr>
                <h4><strong>Transaksi </strong><strong style="color:#2146C7">Selesai</strong></h4>
                <hr>
            </center>
            <div class="table-responsive">
                <table class="table table-bordered text-center" style="border-radius:0.5rem;">
